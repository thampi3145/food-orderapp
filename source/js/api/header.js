...
const API_URL = `${env.PORT}/api/v1/getHeaderComponent`;
...
const fetchHeaderComponent = (path, userOptions = {}) => {
...
function getHeaderDetails(selectid) {
  return fetchHeaderComponent(selectid);
}
