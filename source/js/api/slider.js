...
const API_URL = `${env.PORT}/api/v1/getSliderDetail`;
...
const fetchSliderComponent = (path, userOptions = {}) => {
...
function getSliderDetails(selectid) {
  return fetchSliderComponent(selectid);
}
