...
//const API_URL = 'http://jsonstub.com/getHeader';
import env  from 'config/env';
//const API_URL = 'http://jsonstub.com/getsliders';
const API_URL = `${env.PORT}/api/v1/getHtmlComponent`;
...
const fetchHtmlComponent = (path, userOptions = {}) => {
...
function getHtmlRenderDetails(selectid) {
  return fetchHtmlComponent(selectid);
}

export default {
  getHtmlRenderDetails,
};
